    ...
    <section className="py-20 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <a href="https://web.whispapp.co" className="text-whisp-dark font-bold hover:underline flex items-center gap-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-96 md:h-80">
            {images.map((src, idx) => (
                <div key={idx} className={`relative rounded-3xl overflow-hidden group ${idx % 2 === 0 ? 'mt-0 md:mt-8' : 'mt-8 md:mt-0'} h-full shadow-lg`}>
                    <img 
                        src={src} 
